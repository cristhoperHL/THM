...
\newcommand{\machineName}{Lame} %nombre de la maquina
\newcommand{\logoMachine}{images/maquina_logo.png} % logo de la maquina
...
\begin{document}
	...
	% comprete.
   %   \begin{figure}[h]
    %  \includegraphics[width=0.8\textwidth]{images/nmap_vulns.jpeg}
     % \end{figure}
